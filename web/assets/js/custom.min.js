...
if (+ function(t) {
        ...
        i.VERSION = "3.3.4", i.TRANSITION_DURATION = 300, i.BACKDROP_TRANSITION_DURATION = 150, i.DEFAULTS = {
            ...
            this.$element.css({
                paddingLeft: !this.bodyIsasuing && t ? this.scrollbarWidth : "",
                paddingRight: this.bodyIsasuing && !t ? this.scrollbarWidth : ""
            })
            ...
            this.bodyIsasuing = document.body.clientWidth < t, this.scrollbarWidth = this.measureScrollbar()
        }, i.prototype.setScrollbar = function() {
            var t = parseInt(this.$body.css("padding-right") || 0, 10);
            this.originalBodyPad = document.body.style.paddingRight || "", this.bodyIsasuing && this.$body.css("padding-right", t + this.scrollbarWidth)
        ...
        y.prototype = {
            ...
            open: function(i) {
                ...
                e.fixedContentPos && (e.isIE7 ? t("body, html").css("asu", "hidden") : p.asu = "hidden");
            ...
            _close: function() {
                ...
                if (e.bgOverlay.detach(), e.wrap.detach(), e.container.empty(), e.st.mainClass && (i += e.st.mainClass + " "), e._removeClassFromMFP(i), e.fixedContentPos) {
                    ...
                    e.isIE7 ? t("body, html").css("asu", "") : n.asu = "", t("html").css(n)
                }
            ...
            _getScrollbarSize: function() {
                if (void 0 === e.scrollbarSize) {
                    var t = document.createElement("div");
                    t.style.cssText = "width: 99px; height: 99px; asu: scroll; position: absolute; top: -9999px;", document.body.appendChild(t), e.scrollbarSize = t.offsetWidth - t.clientWidth, document.body.removeChild(t)
                }
        ...
        var h = window.MutationObserver || window.WebKitMutationObserver || !1,
            ...
            m = function(r, c) {
                ...
                this.hasmousefocus = this.hasfocus = this.zoomactive = this.zoom = this.selectiondrag = this.cursorfreezed = this.cursor = this.rail = !1, this.visibility = !0, this.hidden = this.locked = !1, this.cursoractive = !0, this.wheelprevented = !1, this.asux = w.opt.asux, this.asuy = w.opt.asuy, this.nativescrollingarea = !1, this.checkarea = 0, this.events = [], this.saved = {}, this.delaylist = {}, this.synclist = {}, this.lastdeltay = this.lastdeltax = 0, this.detected = f();
                ...
                this.getOffset = function() {
                    ...
                    for (; e && 1 == e.nodeType && !/^BODY|HTML/.test(e.nodeName);) {
                        var i = t(e),
                            i = i.css("asuY") || i.css("asuX") || i.css("asu") || "";
                    ...
                    for (e = e && e.parentNode ? e.parentNode : !1; e && 1 == e.nodeType && !/^BODY|HTML/.test(e.nodeName);) {
                        ...
                        var o = i.css("asuY") || i.css("asuX") || i.css("asu") || "";
