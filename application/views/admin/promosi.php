          ...
          <div class="box">
            ...
            <div id="toolbar" class="btn-group">
             <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
              <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah promosi
            </button>
          </div>
              <table id="all_data_json" data-toggle="table" data-url="<?=base_url()?>admin_promosi/get_json_promosi"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc" data-toolbar="#toolbar">
                        <thead>
                        <tr>
                            <th data-formatter="numberFormatter" >No</th>
                            <th data-field="title_promosi" data-sortable="true">Nama promosi</th>
                            <th data-field="gambar_promosi"  data-formatter="format_gambar_tabel_promosi">Gambar</th>
                           
                            <th data-field="id_promosi" data-formatter="promosi_action" data-sortable="true"></th>
...
<div class="modal fade bs-example-modal-lg" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form method="POST" action="<?=base_url()?>admin_promosi/add_promosi" enctype="multipart/form-data">
      ...
      <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="judul_promosi" placeholder="Nama promosi" required >
          </div>
          <div class="form-group">
            <label for="isi_layanan">Deskripsi promosi</label>
             <textarea class="ckeditor" name="deskripsi_promosi" id="editor1" required ></textarea>
