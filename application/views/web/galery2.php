            ...
            <div class="post-head media">
              ...
              <div class="media-body">
                ...
                <div class="share-post pull-right">
                  <ul class="share-list">
                    <li><a target="_BLANK" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo base_url("news/read/".$read->url."/".$read->id_galeri)?>"><i class="fa fa-facebook"></i></a></li>
  ...
  <hr>
            ...
            <?php if ($read->gambar_galeri!='galeri_default.jpg'){?>
              <div class="post-thumbnail">
                ...
                <img src="<?php echo base_url("assets/images/galeri/".$read->gambar_galeri	)?>" alt="post Image" class="img-thumbnail">
              </div><!-- /.post-thumbnail -->
              <?php }?>
                  ...
                  <ul class="products-list product-list-in-box">
                     <?php foreach ($recent as $key){?>
                      ...
                      <div class="product-img">
                        <img src="<?php echo base_url()?>assets/images/galeri/<?php echo $key->gambar_galeri?>" alt="News Image">
                      </div>
                      <div class="product-info">
                        <a href="<?php echo base_url()?>news/read/<?php echo $key->url?>/<?php echo $key->id_galeri?>" class="naomi-product-title"><?php echo $key->title_galeri?> </a>
